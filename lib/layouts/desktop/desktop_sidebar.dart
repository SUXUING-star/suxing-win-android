...
class DesktopSidebar extends StatelessWidget {
  ...
  Widget _buildSidebarNavigation(
      BuildContext context, SidebarProvider sidebarProvider) {
    final int currentSidebarIndex = sidebarProvider.currentIndex;
    return ListView(
      ...
      children: _getNavItems()
          .map((item) => DesktopSidebarNavItem(
                ...
                onTap: () => _navigateToMainScreen(
                    context, item['index'], sidebarProvider),
              ))
          .toList(),
    );
  }
  ...
  void _navigateToMainScreen(
      BuildContext context, int index, SidebarProvider sidebarProvider) {
                  ...
                  return Column(
                    children: [
                      ...
                      DesktopSidebarUserProfile(
                        onProfileTap: () =>
                            _navigateToMainScreen(context, 5, sidebarState),
                      ),

                      // 导航菜单（可滚动）
                      Expanded(
                        child: _buildSidebarNavigation(context, sidebarState),
                      ),
