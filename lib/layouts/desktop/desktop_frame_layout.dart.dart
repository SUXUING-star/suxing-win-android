...
class DesktopFrameLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget paddedChild = Padding(
      padding: const EdgeInsets.only(top: kDesktopTitleBarHeight),
      child: child,
    );
    ...
    Widget titleIconWidget = DragToMoveArea(
      child: Container(
    ...
    Widget titleToolBarWidget = StreamBuilder<bool>(
      ...
      builder: (context, isLoggedInSnapshot) {
        ...
        return Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildTitleBarButtonWrapper(const UpdateButton(), '检查更新'),
