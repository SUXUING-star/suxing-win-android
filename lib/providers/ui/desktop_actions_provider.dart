...
class DesktopActionsProvider extends ChangeNotifier {
  ...
  void setActions(List<Widget>? newActions, {bool showBackButton = false}) {
    ...
    print("DesktopActionsProvider state updated: actions=${_actions.length}, showBackButton=$_showBackButton");
...
// 注意：需要添加 collection 包到 pubspec.yaml:
// dependencies:
//   flutter:
//     sdk: flutter
//   collection: ^1.17.0 # 或者最新版本