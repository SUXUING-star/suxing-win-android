// lib/models/game/collection/collection_item_response_pagination.dart

import 'package:suxingchahui/models/common/pagination.dart';
import 'package:suxingchahui/models/game/collection/collection_item_response.dart';
import 'package:suxingchahui/models/utils/util_json.dart';

class CollectionItemResponsePagination {
  ...
  final List<CollectionItemResponse> reviews;
  final PaginationData pagination;
  final String gameId;

  CollectionItemResponsePagination({
  ...
  // 静态工厂方法，用于创建一个空的实例
  static CollectionItemResponsePagination empty(String gameIdForEmpty) {
    return CollectionItemResponsePagination(
      reviews: [],
  ...
  factory CollectionItemResponsePagination.fromJson(Map<String, dynamic> json) {
    final reviewsList =
        CollectionItemResponse.fromListJson(json[jsonKeyReviews]);
  ...
  CollectionItemResponsePagination copyWith({
    List<CollectionItemResponse>? reviews,
  ...
  @override
  String toString() {
    return 'GameCollectionReviewList($jsonKeyReviews: ${reviews.length}, $jsonKeyPagination: $pagination, $jsonKeyGameId: $gameId)';
  }
}
