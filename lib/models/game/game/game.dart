// lib/models/game/game/game.dart
...
class Game implements ToJsonExtension {
  static const String updateGameResultTypeEdited = 'edited';
  static const String updateGameResultTypeResubmitted = 'resubmitted';
  ...
  factory Game.fromJson(Map<String, dynamic> json) {
    final bvid = UtilJson.parseBvid(json[jsonKeyBvid]);
    final rawMusicUrl =
        UtilJson.parseNullableStringSafely(json[jsonKeyMusicUrl]);
    return Game(
      ...
      downloadLinks: GameDownloadLink.fromListJson(json[jsonKeyDownloadLinks]),
      externalLinks: GameExternalLink.fromListJson(json[jsonKeyExternalLinks]),
