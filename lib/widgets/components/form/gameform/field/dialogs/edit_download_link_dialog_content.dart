...
class _EditDownloadLinkDialogContentState
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(text: widget.initialLink.description);
  }
  ...
  // 辅助方法，统一定义输入框样式
  InputDecoration _inputDecoration(ThemeData theme, String labelText, String hintText) {
            ...
            Row(
              ...
              children: [
                ...
                _isSaving
                    ? Container( // Loading
                  padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                  height: 44, constraints: const BoxConstraints(minWidth: 88),
                  alignment: Alignment.center,
                  child: const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2.5)),
                )
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 2, shadowColor: theme.primaryColor.withOpacity(0.4),
