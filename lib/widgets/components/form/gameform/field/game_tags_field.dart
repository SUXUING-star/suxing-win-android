...
/// 该文件定义了 GameTagsField 组件，用于游戏标签的输入和管理。
/// GameTagsField 提供一个复合输入体验：
/// 1. 用户可以手动输入新标签。
...
/// `GameTagsField` 类：游戏标签输入和管理的 StatefulWidget。
///
...
class _GameTagsFieldState extends State<GameTagsField> {
  ...
  @override
  void didUpdateWidget(covariant GameTagsField oldWidget) {
