// lib/widgets/components/form/gameform/field/game_external_links_form_field.dart

/// 该文件定义了 [GameExternalLinksFormField] 组件，用于管理游戏的外部链接。
/// [GameExternalLinksFormField] 提供添加、编辑和删除外部链接的功能。
library;
...
/// [GameExternalLinksFormField] 类：管理游戏外部链接的 StatelessWidget。
///
/// 该组件提供一个界面，用于添加、编辑和删除游戏的外部链接。
class GameExternalLinksFormField extends StatelessWidget {
  ...
  const GameExternalLinksFormField({
    super.key,
