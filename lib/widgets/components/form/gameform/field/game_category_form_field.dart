// lib/widgets/components/form/gameform/field/game_category_form_field.dart
import 'package:flutter/material.dart';
import 'package:suxingchahui/models/game/game/enrich_game_category.dart';

class GameCategoryFormField extends StatelessWidget {
  static const List<String> categoryOptions = EnrichGameCategory.defaultGameCategory;

  final String? selectedCategory;
  final ValueChanged<String?> onChanged;

  const GameCategoryFormField({
    super.key,
