// lib/widgets/components/screen/forum/post/section/reply/post_replies_list_section.dart
...
class PostRepliesListSection extends StatefulWidget {
  ...
  @override
  State<PostRepliesListSection> createState() => _PostRepliesListSectionState();
}

class _PostRepliesListSectionState extends State<PostRepliesListSection> {
  ...
  @override
  void didUpdateWidget(covariant PostRepliesListSection oldWidget) {
