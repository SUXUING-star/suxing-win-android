// lib/widgets/components/screen/forum/post/button/post_actions_buttons.dart

/// 该文件定义了 [PostActionsButtons]  组件，用于帖子交互操作。
...
/// [PostActionsButtons] 类：帖子交互按钮的 UI 组件。
///
...
class PostActionsButtons extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        _buildInteractionButton(
          icon: hasShared ? Icons.share_sharp : Icons.share_outlined, // 点赞图标
          label: '分享该帖子', // 点赞计数
          color:
              hasShared ? Theme.of(context).primaryColor : Colors.grey, // 图标颜色
          onTap: onShare, // 点赞回调
          isLoading: isSharing, // 点赞加载状态
          iconSize: iconSize,
          fontSize: fontSize,
          padding: padding,
        ),
  ...
  Widget _buildInteractionButton({
    ...
    required FutureVoidCallback onTap,
