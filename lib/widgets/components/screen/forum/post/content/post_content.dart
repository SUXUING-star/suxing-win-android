...
import 'package:suxingchahui/widgets/components/screen/forum/post/button/post_interaction_buttons.dart'; // 帖子交互按钮组件
import 'package:suxingchahui/widgets/components/screen/forum/post/tag/post_tags.dart'; // 帖子标签组件
...
class PostContent extends StatelessWidget {
  ...
  final VoidCallback onToggleLike; // 点击“点赞”按钮的回调

  final VoidCallback onToggleAgree; // 点击“赞同”按钮的回调

  final VoidCallback onToggleFavorite; // 点击“收藏”按钮的回调
