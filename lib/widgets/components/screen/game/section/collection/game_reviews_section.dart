// lib/widgets/components/screen/game/section/collection/game_reviews_section.dart
...
import 'package:suxingchahui/models/game/collection/collection_item_response.dart'; // 游戏评价项模型
import 'package:suxingchahui/models/game/collection/collection_item_response_pagination.dart'; // 游戏评价分页模型
...
import 'package:suxingchahui/widgets/ui/components/game/review/game_review_item_widget.dart'; // 游戏评价项组件
...
class GameReviewSectionState extends State<GameReviewSection> {
  List<CollectionItemResponse> _reviews = []; // 存储游戏评价列表
  ...
  Future<void> _loadReviews({bool isInitialLoad = false}) async {
    ...
    try {
      final CollectionItemResponsePagination reviewListResult = await widget
